...
/**
 * AbstractAwtView is a <b>cool</b> class.
 * 
 * @author Filipe Tavares
 * @author Belmiro Sotto-Mayor
 * @version $Revision$ ($Author$)
 */
public abstract class AbstractAwtView<C> extends AbstractView<C> {
    ...
    protected void addComponent(Component component, int x, int y, int xWeight, int yWeight) {
