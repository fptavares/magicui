...
/**
 * AbstractAwtComponent is a <b>cool</b> class.
 * 
 ...
 */
public abstract class AbstractAwtComponent<C extends Component, T> extends AbstractValueComponent<C, T> {
		...
		if (type.equals(EVENT_CLICK)) {
			listener = new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					action.act(AbstractAwtComponent.this.getParent().getState());
				}
			};
